...
//
// ЦЕНООБРАЗОВАНИЕ: 1 кредит = 1 ₽ себестоимости по ОФИЦИАЛЬНОМУ прайсу модели.
// Продаём кредит за 2 ₽. Покупаем ниже рынка (kie.ai / OpenRouter) — разница
// уходит в маржу сверх наценки.
//
// ВАЖНО: прайсы моделей живые и меняются. Этот файл — витрина для интерфейса;
// боевой расчёт списания должен брать in/out из таблицы model_rates, которую
// джоба обновляет из каталогов kie и OpenRouter. Формула одна и та же.
//
...
/** курс для перевода долларового прайса в рубли (как USD_RUB в api/llmUsage) */
export const USD_RUB = 90
/**
 * Цена кредита для клиента. Внутренняя математика осталась рублёвой (1 кредит =
 * 1 ₽ официальной себестоимости, продажа за 2 ₽ — см. api/credits), а витрина
